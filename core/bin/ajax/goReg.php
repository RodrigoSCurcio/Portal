...
//SE TIVER ALGUM PROBLEMA COM O ENVIO SEJA TLS OU SSL USE AS LINHAS ABAIXO
...
if(!$mail->send()) {
    ...
    $data = date('d/m/Y');
    $db->query("INSERT INTO users (user, email, pass, keyreg, data_registro) VALUES ('$user', '$email', '$pass', '$keyreg', '$data');");
