...
<div class="mbr-section__container container mbr-section__container--isolated">
  ...
  if(isset($_GET['success'])) {
    echo '<div class="alert alert-dismissible alert-success">
      <strong>Criada!</strong> O Fórum foi criado com sucesso.
    </div>';
...
<div class="row categorias_con_foros">
  <div class="col-sm-12">
      ...
      <div class="row cajas">
        <div class="col-md-12">
          <form class="form-horizontal" action="?view=configForuns&mode=add" method="POST" enctype="application/x-www-form-urlencoded">
            <fieldset>
              <div class="form-group">
                <label for="inputEmail" class="col-lg-2 control-label">Nome</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="nome" placeholder="Nome para o Fórum">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" class="form-control" maxlength="250" name="descricao" placeholder="Descrição curta (aceita HTML)">
                </div>
              </div>
              <div class="form-group">
