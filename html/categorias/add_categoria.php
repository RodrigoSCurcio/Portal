...
<div class="mbr-section__container container mbr-section__container--isolated">
  ...
  if(isset($_GET['success'])) {
    echo '<div class="alert alert-dismissible alert-success">
      <strong>Criada!</strong> A Categoria criada com sucesso.
    </div>';

    echo "<meta HTTP-EQUIV='Refresh' CONTENT='3; URL=?view=categorias'";
          ...
          <form class="form-horizontal" action="?view=categorias&mode=add" method="POST" enctype="application/x-www-form-urlencoded">
            <fieldset>
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="nome" placeholder="Nome para a categoria">
                </div>
              </div>
              <div class="form-group">
