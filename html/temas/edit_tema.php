...
<div class="row categorias_con_foros">
  <div class="col-sm-12">
      <div class="row titulo_categoria">Editar Tema - <?php echo $tema['titulo'] ?></div>

      <div class="row cajas">
        <div class="col-md-9">
          <form class="form-horizontal" action="?view=temas&mode=edit&id_forum=<?php echo $id_forum ?>&id=<?php echo $_GET['id']; ?>" method="POST" enctype="application/x-www-form-urlencoded">
            <fieldset>
              <div class="form-group">
                <label for="inputEmail" class="col-lg-2 control-label">Título</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="titulo" placeholder="Título para o tema" value="<?php echo $tema['titulo']; ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <textarea class="form-control tema_texarea" name="conteudo" placeholder="Conteúdo (aceita HTML)" ><?php echo $tema['conteudo']; ?></textarea>
                </div>
              </div>
             ...
             <?php if($users[$_SESSION['app_id']]['permissoes']>0){
              ...
              echo ' <div class="form-group">
                ...
                <label class="col-lg-10">
                  ...
                  <input type="checkbox" value="1" name="anuncio" '.$checked.'/>
